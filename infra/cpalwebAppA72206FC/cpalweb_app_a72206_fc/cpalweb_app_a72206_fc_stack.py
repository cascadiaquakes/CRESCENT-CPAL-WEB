...
"""
class CpalwebAppA72206FcStack(Stack):
  def __init__(self, scope: Construct, construct_id: str, config: DeploymentEnvironmentConfig, **kwargs) -> None:
    ...
    albFargateServiceLbSecurityGroup051D028d = ec2.CfnSecurityGroup(self, 'AlbFargateServiceLBSecurityGroup051D028D',
          group_description = 'Automatically created Security Group for ELB cpalwebAppAlbFargateServiceLB0A30A75F',
    ...
    fargateTaskB499db9f = ecs.CfnTaskDefinition(self, 'FargateTaskB499DB9F',
          container_definitions = [
            {
              ...
              'logConfiguration': {
                ...
                'options': {
                  ...
                  'awslogs-stream-prefix': 'cpal-web-crescent-cpal-web-web',
          ...
          family = 'cpalwebAppFargateTask1BF973D8',
          memory = '8192',
          network_mode = 'awsvpc',
    ...
    albFargateServiceDnsd893ec68 = route53.CfnRecordSet(self, 'AlbFargateServiceDNSD893EC68',
          ...
          hosted_zone_id = 'Z0196977LOZKZPCOOQJ2',
    ...
    albFargateServiceLbPublicListenerCb0a3f85 = elasticloadbalancingv2.CfnListener(self, 'AlbFargateServiceLBPublicListenerCB0A3F85',
          certificates = [
            {
              'certificateArn': 'arn:aws:acm:us-east-2:818214664804:certificate/3e0ec24a-440b-4521-a8ce-b2114cca3894',
            },
          ],
          default_actions = [
            {
    ...
    albFargateServiceSecurityGroup81F44dcf = ec2.CfnSecurityGroup(self, 'AlbFargateServiceSecurityGroup81F44DCF',
          group_description = 'cpal-web/App/AlbFargateService/Service/SecurityGroup',
    ...
    albFargateServiceLbSecurityGrouptocpalwebAppAlbFargateServiceSecurityGroup324C63e080ed51c167 = ec2.CfnSecurityGroupEgress(self, 'AlbFargateServiceLBSecurityGrouptocpalwebAppAlbFargateServiceSecurityGroup324C63E080ED51C167',
    ...
    albFargateServiceSecurityGroupfromcpalwebAppAlbFargateServiceLbSecurityGroup4116C58680edc6fe89 = ec2.CfnSecurityGroupIngress(self, 'AlbFargateServiceSecurityGroupfromcpalwebAppAlbFargateServiceLBSecurityGroup4116C58680EDC6FE89',
          description = 'Load balancer to target',
          from_port = 80,
    ...
    albFargateServiceSecurityGroupfromcpalwebAppAlbFargateServiceLbSecurityGroup4116C58680edc6fe89.add_dependency(fargateClusterA52aec7a)
    albFargateServiceSecurityGroupfromcpalwebAppAlbFargateServiceLbSecurityGroup4116C58680edc6fe89.add_dependency(fargateTaskTaskRoleDefaultPolicy343D3d72)
    albFargateServiceSecurityGroupfromcpalwebAppAlbFargateServiceLbSecurityGroup4116C58680edc6fe89.add_dependency(fargateTaskTaskRoleB7c51ec5)
